...
class UserEditMobile extends StatefulWidget {
  ...
  UserEditMobile({required this.url});
  @override
  _UserEditMobile createState() => _UserEditMobile();
}

class _UserEditMobile extends State<UserEditMobile> {
  ...
  Map<String, String> getUserData(AppState state) {
    return {
      'email': state.email!,
      'username': state.uid!,
    };
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Container(
                      width: screenWidth >= 620 ? 175 : 165,
                      height: screenWidth >= 620 ? 40 : 35,
