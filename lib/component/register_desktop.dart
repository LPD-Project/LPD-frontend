...
class RegisterDesktop extends StatefulWidget {
  late String url;
  RegisterDesktop({required this.url});

  @override
  State<RegisterDesktop> createState() => _RegisterDesktop();
}

class _RegisterDesktop extends State<RegisterDesktop> {
  ...
  Future<void> uploadImage(email, uid) async {
    ...
    if (response.statusCode == 200) {
      ...
      showAlertDialog(context, "file to large");
    }
  }
